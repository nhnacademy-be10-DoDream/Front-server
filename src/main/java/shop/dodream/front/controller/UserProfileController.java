...
public class UserProfileController {
    ...
    @PutMapping("/password")
    public String updatePassword(@Valid @ModelAttribute UserPasswordUpdateDto userPasswordUpdateDto,
                                 Model model) {
    ...
    public String createAddress(@Valid @ModelAttribute UserAddressDto userAddressDto) {
    ...
    public String updateAddress(@PathVariable("address-id") Long addressId,
                                @Valid @ModelAttribute UserAddressDto userAddressDto) {
